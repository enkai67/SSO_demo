...
app.get("/validate", async (req, res) => {
    ...
    try {
        const serviceValidateUrl = `${CAS_URL}/serviceValidate?service=${encodeURIComponent(SERVICE_URL)}&ticket=${ticket}`;
        ...
        if (axiosResponse.data.serviceResponse.authenticationSuccess) {
            ...
            res.setHeader("Set-Cookie", "isApp1LoggedIn=true; Max-Age=80000");
...
app.post("/logout", (req, res) => {
    res.setHeader("Set-Cookie", "isApp1LoggedIn=; Max-Age=0; Path=/");
